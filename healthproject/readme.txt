TOPIC: Health
PROBLEM STATEMENT: Develop a website/mobile application showcasing the digitalisation in healthcare and providing solutions for a healthy life.
...
TECH STACK: front-end (html,css,js), back-end(django with postgre)

DESCRIPTION: We have created a web application pertaining to the given topic. Our project consists of 4 major parts:
...
RUNNING THE PROJECT: To run our project,
